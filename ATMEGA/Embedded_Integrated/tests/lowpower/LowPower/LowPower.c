...
*******************************************************************************/
/*
 * Library adapted from C++ to C by ADA - Projetos de Engenharia de Comptacao
...
*
*******************************************************************************/
void	adcNoiseReduction(period_t period, adc_t adc,
										 timer2_t timer2)
{
	// Temporary clock source variable
	unsigned char clockSource = 0;
...
*
*******************************************************************************/
void	powerSave(period_t period, adc_t adc, bod_t bod,
							     timer2_t timer2)
{
	// Temporary clock source variable
	unsigned char clockSource = 0;
...
*
*******************************************************************************/
void	powerExtStandby(period_t period, adc_t adc, bod_t bod,
									   timer2_t timer2)
{
	// Temporary clock source variable
	unsigned char clockSource = 0;
