...
#define _ADC0832_CS PORTC0

#define _ADC0832_DO_DDR DDRC
#define _ADC0832_DO_PIN PINC
#define _ADC0832_DO PINC1

#define _ADC0832_DI_DDR DDRC
#define _ADC0832_DI_PORT PORTC
#define _ADC0832_DI PORTC2

#define _ADC0832_CLK_DDR DDRC
#define _ADC0832_CLK_PORT PORTC
#define _ADC0832_CLK PORTC3

#define _ADC0832_PULSE_WIDTH 100 //us
#define _ADC0832_DELAY_WRITE 100 //us
#define _ADC0832_DELAY_MSB 100 //us
#define _ADC0832_DELAY_LSB 100 //us

#define ADC0832_DELAY_AVR_CONV 50 //ms
