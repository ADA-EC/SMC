...
typedef enum timer5_t
{
	TIMER5_OFF,
	TIMER5_ON
} timer5_t;

typedef enum timer4_t
{
	TIMER4_OFF,
	TIMER4_ON
} timer4_t;

typedef enum timer3_t
{
	TIMER3_OFF,
	TIMER3_ON
} timer3_t;

typedef enum timer2_t
{
	TIMER2_OFF,
	TIMER2_ON
} timer2_t;

typedef enum timer1_t
{
	TIMER1_OFF,
	TIMER1_ON
} timer1_t;

typedef enum timer0_t
{
	TIMER0_OFF,
	TIMER0_ON
} timer0_t;
...
typedef enum usart0_t
{
	USART0_OFF,
	USART0_ON
} usart0_t;

typedef enum usart1_t
{
	USART1_OFF,
	USART1_ON
} usart1_t;

typedef enum usart2_t
{
	USART2_OFF,
	USART2_ON
} usart2_t;

typedef enum usart3_t
{
	USART3_OFF,
	USART3_ON
} usart3_t;
